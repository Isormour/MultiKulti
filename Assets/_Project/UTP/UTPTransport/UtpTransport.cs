    ...
    public class UtpTransport : Transport
    {
        ...
        private void Awake()
        {
            ...
            server = new UtpServer(
                (connectionId) => OnServerConnectedWithAddress.Invoke(connectionId, ""),
        ...
        private void SetupDefaultCallbacks()
        {
            ...
            {
                OnServerConnectedWithAddress = (connId, str) => UtpLog.Warning("OnServerConnected called with no handler");
            }
